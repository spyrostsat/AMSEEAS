...
from math import log, inf, nan, sqrt, exp, sin, cos, pi, floor
...
def seeas(n, m, xmin, xmax, fn, maxeval, ftol=10 ** (-6), pmut=0.1, beta=2, maxclimbs=3):
    ...
    global S, we, coef, record_Ypred, record_dist, xlow_help, xup_help, RefTrials
    ...
    while neval <= maxeval:
        ...
        print(f"Current Number of Function Evaluations is {neval} and current Best Value is {fpop.min():.4f}")
    ...
    print(f"\n=============================================")
    print(f"SEEAS execution lasted {duration:.2f} seconds")
    print(f"=============================================\n")
